"""CLI extension models for libspec specifications.

This module defines models for command-line interface specifications:
- Commands, subcommands, arguments
- Options, flags, environment variables
- Shell completion, help formatting
"""

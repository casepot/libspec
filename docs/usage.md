...
- Path-like fields must exist when strict: workflow evidence, coverage targets, config file locations, plugin discovery directories, and ORM migration directories.
